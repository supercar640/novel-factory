...
VALID_ACTIONS: dict[tuple[str, str], list[str]] = {
    # Phase 1
    (Phase.PHASE1.value, Step.DIRECTION_PROPOSAL.value): ["add", "next"],
    ...
    (Phase.PHASE3.value, Step.MODE_SELECTION.value): ["config", "next"],
    (Phase.PHASE3.value, Step.WRITING.value): ["save", "next"],
    (Phase.PHASE3.value, Step.WRITING_DECISION.value): ["approve", "revise", "reject"],
    # Phase 4
    (Phase.PHASE4.value, Step.PROOFREADING.value): ["save", "next"],
